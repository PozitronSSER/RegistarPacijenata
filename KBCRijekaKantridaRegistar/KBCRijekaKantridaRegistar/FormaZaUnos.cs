...
{
    public partial class FormaZaUnos : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                krvarenje = Convert.ToString(chkBoxPatologijatrudnoceKrvarenje.Checked);
                dijabetes = Convert.ToString(chkBoxPatologijatrudnoceDijabetes.Checked);
                ppi = Convert.ToString(chkBoxPatologijatrudnocePPI.Checked);
                infekcije = Convert.ToString(chkBoxPatologijatrudnoceInfekcije.Checked);
                hipertenzija = Convert.ToString(chkBoxPatologijatrudnoceHipertenzija.Checked);
                eph = Convert.ToString(chkBoxPatologijatrudnoceEPH.Checked);
                ostaloTextPatologija = txtPatologijaTrudnoćeOstalo.Text;
                hipoglikemija = Convert.ToString(chkBoxNovorođenčeHipoglikemija.Checked);
                rds = Convert.ToString(chkBoxNovorođenčeRDS.Checked);
                mehaničkaventilacija = Convert.ToString(chkBoxNovorođenčeMehVentilacija.Checked);
                sepsa = Convert.ToString(chkBoxNovorođenčeSepsa.Checked);
                hiperbilirubinemija = Convert.ToString(chkBoxNovorođenčeHiperbilirubinemija.Checked);
                konvulzije = Convert.ToString(chkBoxNovorođenčeKonvulzije.Checked);
                pvl = Convert.ToString(chkBoxNovorođenčePVL.Checked);
                pv_ivh = Convert.ToString(chkBoxNovorođenčePVIVH.Checked);
                nec = Convert.ToString(chkBoxNovorođenčeNEC.Checked);
                rop = Convert.ToString(chkBoxNovorođenčeROP.Checked);
                ostaloTextKomplikacije = txtNovorođenčeOstalo.Text;
                ostaloPatologija = Convert.ToString(chkBoxPatologijaTrudnoćeOstalo.Checked);
                ostaloKomplikacije = Convert.ToString(chkBoxNovorođenčeOstalo.Checked);
                ...
                //MessageBox s svim podatcima("Jeste li sigurni da želite spremiti?"
                DialogResult dialogResult = MessageBox.Show(" Ime: " + ime + "\n Prezime: " + prezime + "\n Imemajke: " + imeMajke +
                    "\n Imeoca: " + imeOca + "\n Adresa: " + adresa + "\n Kontakt_telefon: " + kontaktTelefon + "Datum_rođenja: "+ 
                    Convert.ToString(datumRodenja) + "\n Spol:" + spol + "\n Paritet_trudnoće: " + paritetTrudnoce+"\n Plodnost_trudnoće: "+trudnocaPlodna
                    + "\n Priroda_trudnoće: " + trudnocaPrirodna + "\n Način_poroda: " +  nacinPoroda + "\n Trajanje_poroda: " +  trajanjePoroda 
                    + "\n Stav_djeteta: " + stavDjeteta + "\n Profilaksa: " + profilaksa+ "\n PROM: " +  prom+ "\n Ferbrilitet: " + febrilitetRodilje +
                    "\n Krvarenje: " + krvarenje + "\n Dijabetes: " + dijabetes + "\n PPI: " +  ppi + "\n Infekcije: " + hipertenzija + "\n EPH: " +  eph +
                    "\n Ostalo_patologija: " + ostaloTextPatologija + "\n Gestacijska_dob_tjedni: " + Convert.ToString(gestacijskaDobTjedana) +
                    "\n Gestacijska_dob_dani: " +  Convert.ToString(gestacijskaDobDana)+ "\n Rodna_masa: " + Convert.ToString(rodnaMasa) +
                     "\n Rodna_duljina: " + Convert.ToString(rodnaDuljina) + "\n Opseg_glave: " +  Convert.ToString(opsegGlave) + "\n Apgar_indeks: " +
                     apgarIndeks  + "\n Reanimacija: " + reanimacija + "\n Hipoglikemija: " + hipoglikemija + "\n RDS: "+rds+ "\n Mehanička_ventilacija: "
                      +mehaničkaventilacija + "\n Sepsa: " + sepsa + "\n Hiperbilirubinemija: " + hiperbilirubinemija + "\n Konvulzije: " + konvulzije +
                     "\n PVL: " + pvl + "\n PV-IVH: " + pv_ivh +  "\n NEC: " + nec + "\n ROP: " + rop + "\n Ostalo_komplikacije: " + 
                     ostaloTextKomplikacije, "\n Želite li spremiti?", MessageBoxButtons.YesNo);
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    if (!File.Exists("Registar.xml"))
                    {
                        ...
                        using (XmlWriter xmlWriter = XmlWriter.Create("Registar.xml", xmlWriterSettings))
                        {
                            ...
                            xmlWriter.WriteElementString("Ostalo_patologija", ostaloTextPatologija);
                    ...
                    else
                    {
                        ...
                        firstRow.AddBeforeSelf(
                            ...
                            new XElement("Ostalo_patologija", ostaloTextPatologija),
